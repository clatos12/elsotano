...
<body id="ofertas">
    ...
    <section class="page-section2">
        <div class="container px-4 px-lg-5">
            ...
            <p class="text-center text-muted">
                Encuentra precios especiales por tiempo limitado en tus libros favoritos.
            </p>
            <hr class="divider" />
        </div>
    </section>
    ...
    <section class="page-section bg-dark text-white">
        <div class="container px-4 px-lg-5 text-center">
            <h2 class="mb-4">No dejes pasar estas oportunidades</h2>
            <p class="mb-4">
                Las mejores historias ahora a precios increíbles.
            </p>
